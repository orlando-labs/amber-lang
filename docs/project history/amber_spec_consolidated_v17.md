> Редакция v17: поверх v16 в эту версию дополнительно включена детализированная матрица имплементации: work packages W0-W10, milestone map M0-M9, parallel lanes, risk register, definition-of-done и стартовый backlog reference repo. Языковые решения v16 не меняются; документ переводит уже закрытую спецификацию в инженерный план реализации.
