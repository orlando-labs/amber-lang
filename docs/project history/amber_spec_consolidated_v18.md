> Редакция v18: поверх v17 в эту версию дополнительно включён репозиторный backlog pack: canonical label taxonomy, expanded issue catalogue ISS-025..ISS-072, milestone gate checklists, issue/PR templates, repo layout и merge rules для reference implementation. Языковые решения v16 и матрица v17 не меняются; документ доводит инженерный план до уровня немедленного запуска репозитория.
...
```text
/spec/
  amber_spec_consolidated_v18.md
  changelog/
/corpus/
  parse/
  lower/
